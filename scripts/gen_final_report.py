...
html += '  <div class="card">\n'
html += (
    "    <p><strong>v0_12 (OptimalHybridGateMoE) decisively outperforms v0_6 (HybridAdaptiveGateMoE):</strong></p>\n"
)
...
html += (
    '      <li><span class="pos">+18.2% Recall</span> (0.17990 vs 0.15215) — better object detection coverage</li>\n'
)
...
shutil.copy(ROOT / "runs" / "moe_voc_compare" / "comparison_plots.png", out_dir / "v0_12_voc_comparison_plots.png")
